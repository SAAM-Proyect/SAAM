...
<nav id='cssmenu'>
    <ul>
        ...
        <li class="has-sub">
            <a href='<?php echo URL."Proyectos"; ?>'><span>Proyectos</span></a>
            <ul>
                <li><a href="<?php echo URL."Proyectos/alta"; ?>">Alta</a></li>
                <li><a href="<?php echo URL."Proyectos/modificaciones"; ?>">Modificaciones</a></li>
            </ul>
        </li>
        <li class="has-sub"><a href=''><span><?php echo ucfirst(Session::getValue('U_NAME')); ?></span></a>
            <ul>
                ...
                <li><a href="<?php echo URL."Proyecto";?>">Inventario</a></li>
